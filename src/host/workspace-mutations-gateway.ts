...
import {
  ...
  type WorkspaceMutationsGatewayContext,
...
export function workspaceMutationsGateway(
  ctx: WorkspaceMutationsGatewayContext,
  config: WorkspaceMutationsGatewayConfig,
): void {
