...
export interface MutationBackendDescriptor {
    ...
    readonly implementation: 'unavailable' | 'windows-nt-handles' | 'linux-openat2-handles' | 'darwin-openat-handles';
    readonly confinement: 'backend-owned-handle-relative-v1' | 'trusted-local-dirfd-relative-v1';
