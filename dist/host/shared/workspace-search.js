...
export function validateSearchGlobs(value, field) {
    if (value === undefined)
        return [];
...
export function matchesSearchPath(path, query) {
...
function nextCodePointOffset(value, offset) {
 ...
 */
export function textSearchPreview(line, first, maxBytes = DEFAULT_PREVIEW_BYTES) {
...
function compileLineMatcher(query) {
...
export function validateTextSearchPattern(query) {
 ...
 */
export function searchTextContent(path, content, query, options = {}) {
    if (!matchesSearchPath(path, query))
        return [];
