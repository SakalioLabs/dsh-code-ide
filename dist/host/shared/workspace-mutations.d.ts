...
export declare const WORKSPACE_MUTATIONS_PROTOCOL: "dsh-code-ide.workspace-mutations.v1";
export declare const WORKSPACE_MUTATIONS_ROUTE: "/dsh-code-ide/api/workspace-mutations/v1";
export declare const MUTATION_BUDGETS: Readonly<{
...
export type WorkspaceMutation = CreateFileMutation | CreateDirectoryMutation | RenameMutation | DeleteMutation;
...
export type WorkspaceMutationRequest = MutationProviderRequest | MutateWorkspaceRequest | MutationStatusRequest;
...
export type WorkspaceMutationResult = CreateMutationResult | RenameMutationResult | DeleteMutationResult;
export type MutationReceiptState = 'queued' | 'running' | 'committed' | 'notCommitted' | 'recoveryRequired' | 'expired';
...
export type MutationReceipt = PendingMutationReceipt | CommittedMutationReceipt | FailedMutationReceipt | ExpiredMutationReceipt;
export {};
